...
(define-condition triangle-error (error)
  ...
  ((triangle-error-sides :initarg :error-sides :reader triangle-error-sides)))
...
(defun triangle (a b c)
  ...
  (check-type b (real (0)))
  (check-type c (real (0)))
  (cond ((<= (+ a b) c) (error 'triangle-error :error-sides (list a b c)))
        ((<= (+ b c) a) (error 'triangle-error :error-sides (list a b c)))
        ((<= (+ c a) b) (error 'triangle-error :error-sides (list a b c))))
