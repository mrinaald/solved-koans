...
(define-test how-to-make-lists
  (let (;; Literal lists can be passed by quoting them.
    ...
    (assert-equal (list 2 4 6) some-evens)
...
(define-test car-and-cdr
  ...
  ;; cons structure.
  (let ((structure '((1 2) (("foo" . "bar")))))   ;; (a . b) is an A-list type
...
(define-test push-pop
  ...
  (let ((place '(10 20 30 40)))
    ...
    ;; (assert-equal '(10 20 30 40) place)    ;; place got modified in inner-let
...
(define-test accessing-list-elements
  (let ((noms '("peanut" "butter" "and" "jelly")))
    ...
    (assert-equal nil (fifth noms))
    (assert-equal nil (eighth noms))
